...
@SpringBootTest
public class GetLifeChannelDataServiceTests {
    ...
    public void tt() {
        ...
        context.setChannelEnum(LifeCircleChannelEnum.LIFE);
        ...
        dataList = factoryService.getServiceForLifeChannel(context).getChannelData(context);
