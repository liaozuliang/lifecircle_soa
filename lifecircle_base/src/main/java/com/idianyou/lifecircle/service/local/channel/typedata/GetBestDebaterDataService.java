...
@Slf4j
@Service
public class GetBestDebaterDataService extends AbstractGetTypeDataService {

    @Override
    public boolean supports(GetTypeDataContext context) {
        return context != null
                && Objects.equals(DataQueryTypeEnum.BEST_DEBATER, context.getQueryTypeEnum())
                && Objects.equals(DataTypeEnum.BEST_DEBATER, context.getDataTypeEnum())
                && Objects.equals(ShowTypeEnum.BEST_DEBATER_SERVICE_DYNAMIC, context.getShowTypeEnum());
    }
