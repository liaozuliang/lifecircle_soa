...
/**
 * @Description: 获取[机器学习-赶集-商户]分类数据
 * @version: v1.0.0
 * @author: liaozuliang
...
@Slf4j
@Service
public class GetLearnMarketMerchantDataService extends AbstractGetTypeDataService {

    @Override
    public boolean supports(GetTypeDataContext context) {
        return context != null
                && Objects.equals(DataQueryTypeEnum.LEARN_MARKET_MERCHANT, context.getQueryTypeEnum())
