...
@Slf4j
@Service
public class GetNovelDataService extends AbstractGetTypeDataService {

    @Override
    public boolean supports(GetTypeDataContext context) {
        return context != null
                && Objects.equals(DataQueryTypeEnum.NOVEL, context.getQueryTypeEnum());
    }
