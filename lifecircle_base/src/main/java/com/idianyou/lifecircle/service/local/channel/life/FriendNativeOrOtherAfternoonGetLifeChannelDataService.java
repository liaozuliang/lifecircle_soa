...
/**
 * @Description: 生活频道查询场景[在赵村有朋友和没有朋友的, 下午]
 * @version: v1.0.0
 * @author: liaozuliang
 * @date: 2020/6/9 16:24
 */
@Slf4j
@Service
public class FriendNativeOrOtherAfternoonGetLifeChannelDataService extends BaseGetChannelDataService {
    ...
    public TypeNum getTypeNum(DataQueryTypeEnum dataQueryTypeEnum) {
        ...
        // 商城(8组，每组6个)
        type_typeNum_map.put(DataQueryTypeEnum.CHI_GUA_MALL, new TypeNum(6, 8));
