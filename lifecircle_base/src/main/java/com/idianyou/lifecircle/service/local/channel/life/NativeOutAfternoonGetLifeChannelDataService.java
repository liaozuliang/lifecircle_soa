...
/**
 * @Description: 生活频道查询场景[赵村人，在外发展, 下午]
 * @version: v1.0.0
 * @author: liaozuliang
 * @date: 2020/6/9 16:24
 */
@Slf4j
@Service
public class NativeOutAfternoonGetLifeChannelDataService extends BaseGetChannelDataService {
    ...
    public TypeNum getTypeNum(DataQueryTypeEnum dataQueryTypeEnum) {
        ...
        // 商城(4组，每组6个)
        type_typeNum_map.put(DataQueryTypeEnum.CHI_GUA_MALL, new TypeNum(6, 4));
