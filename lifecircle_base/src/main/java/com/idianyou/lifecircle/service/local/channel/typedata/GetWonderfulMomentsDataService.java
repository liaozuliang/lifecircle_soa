...
@Slf4j
@Service
public class GetWonderfulMomentsDataService extends AbstractGetTypeDataService {

    @Override
    public boolean supports(GetTypeDataContext context) {
        return context != null
                && Objects.equals(DataQueryTypeEnum.WONDERFUL_MOMENTS, context.getQueryTypeEnum())
                && Objects.equals(DataTypeEnum.WONDERFUL_MOMENTS, context.getDataTypeEnum())
                && Objects.equals(ShowTypeEnum.WONDERFUL_MOMENTS_SERVICE_DYNAMIC, context.getShowTypeEnum());
    }
