...
/**
 * @Description: 推荐频道查询场景[在赵村有朋友和没有朋友的, 早上]
 * @version: v1.0.0
 * @author: liaozuliang
 * @date: 2020/6/9 16:23
 */
@Slf4j
@Service
public class FriendNativeOrOtherMorningGetRecommendChannelDataService extends BaseGetChannelDataService {
    ...
    public TypeNum getTypeNum(DataQueryTypeEnum dataQueryTypeEnum) {
        ...
        // 精彩瞬间(3条)
        type_typeNum_map.put(DataQueryTypeEnum.WONDERFUL_MOMENTS, new TypeNum(3, 1));
    ...
    public List<DataQueryTypeEnum> getSortTypeList() {
        ...
        /**
         * boss开讲》直播》精彩瞬间》商城》K歌之王》最佳辩手》孺子牛消息》商品》农户》
         */
