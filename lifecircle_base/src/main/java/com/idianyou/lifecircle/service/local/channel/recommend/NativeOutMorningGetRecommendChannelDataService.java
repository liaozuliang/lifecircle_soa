...
/**
 * @Description: 推荐频道查询场景[赵村人，在外发展, 早上]
 * @version: v1.0.0
 * @author: liaozuliang
 * @date: 2020/6/9 16:23
 */
@Slf4j
@Service
public class NativeOutMorningGetRecommendChannelDataService extends BaseGetChannelDataService {
    ...
    public List<DataQueryTypeEnum> getSortTypeList() {
        ...
        /**
         * 孺子牛消息》农户》商品》boss开讲》直播》商户》商城》精彩瞬间》K歌之王》最佳辩手
         */
