...
/**
 * @Description: 推荐频道查询场景[在赵村有朋友和没有朋友的, 下午]
 * @version: v1.0.0
 * @author: liaozuliang
 * @date: 2020/6/9 16:24
 */
@Slf4j
@Service
public class FriendNativeOrOtherAfternoonGetRecommendChannelDataService extends BaseGetChannelDataService {
    ...
    public List<DataQueryTypeEnum> getSortTypeList() {
        ...
        /**
         * K歌之王》最佳辩手》精彩瞬间》boss开讲》直播》商城》商品》农户》孺子牛消息》
         */
