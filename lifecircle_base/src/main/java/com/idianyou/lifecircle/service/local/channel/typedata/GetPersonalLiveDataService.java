...
/**
 * @Description: 获取[个人直播]赶集直播样式分类数据
 * @version: v1.0.0
 * @author: liaozuliang
...
@Slf4j
@Service
public class GetPersonalLiveDataService extends AbstractGetTypeDataService {

    @Override
    public boolean supports(GetTypeDataContext context) {
        return context != null
                && Objects.equals(DataQueryTypeEnum.PERSONAL_LIVE, context.getQueryTypeEnum())
                && Objects.equals("全民直播", context.getServiceName())
                && Objects.equals(DataTypeEnum.MARKET.getClientId(), context.getClientId())
                && Objects.equals(DataTypeEnum.MARKET, context.getDataTypeEnum())
                && Objects.equals(ShowTypeEnum.MARKET_LIVE, context.getShowTypeEnum());
    }
