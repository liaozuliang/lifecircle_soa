...
/**
 * @Description: 生活频道查询场景[赵村人，在外发展, 中午]
 * @version: v1.0.0
 * @author: liaozuliang
 * @date: 2020/6/9 16:23
 */
@Slf4j
@Service
public class NativeOutNooningGetLifeChannelDataService extends BaseGetChannelDataService {
    ...
    public void removeExtraData(Map<DataQueryTypeEnum, List<ChannelDataGroupVO>> type_group_map) {
        ...
        // 商品(4组，每组6个)
        removeExtraData2(type_group_map, Arrays.asList(DataQueryTypeEnum.LEARN_MARKET_PRODUCT, DataQueryTypeEnum.MARKET_PRODUCT), 4);
    ...
    public TypeNum getTypeNum(DataQueryTypeEnum dataQueryTypeEnum) {
        ...
        // 商品 + 机器学习-商品（4组，每组6个）
        type_typeNum_map.put(DataQueryTypeEnum.MARKET_PRODUCT, new TypeNum(6, 4));
        type_typeNum_map.put(DataQueryTypeEnum.LEARN_MARKET_PRODUCT, new TypeNum(6, 4));
