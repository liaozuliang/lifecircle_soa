...
@Slf4j
@Service
public class GetMarketLiveDataService extends AbstractGetTypeDataService {

    @Override
    public boolean supports(GetTypeDataContext context) {
        return context != null
                && Objects.equals(DataQueryTypeEnum.MARKET_LIVE, context.getQueryTypeEnum())
                && Objects.equals("全民直播", context.getNotServiceName())
