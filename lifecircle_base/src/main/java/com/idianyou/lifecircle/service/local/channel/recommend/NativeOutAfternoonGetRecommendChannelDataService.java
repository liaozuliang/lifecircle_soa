...
/**
 * @Description: 推荐频道查询场景[赵村人，在外发展, 下午]
 * @version: v1.0.0
 * @author: liaozuliang
 * @date: 2020/6/9 16:24
 */
@Slf4j
@Service
public class NativeOutAfternoonGetRecommendChannelDataService extends BaseGetChannelDataService {
    ...
    public List<DataQueryTypeEnum> getSortTypeList() {
        ...
        /**
         * 精彩瞬间》农户》最佳辩手》K歌之王》boss开讲》直播》商品》孺子牛消息》商户》商城》
         */
